...
def chat():
    # --- FIX: Get userMessage from JSON ---
    data = request.get_json()
    user_message = (data or {}).get('userMessage', '').strip()
    ...
    if not response_text or response_text.isspace():
        response_text = f"Sorry, I couldn't provide a relevant answer to: '{user_message}'. Please rephrase."
